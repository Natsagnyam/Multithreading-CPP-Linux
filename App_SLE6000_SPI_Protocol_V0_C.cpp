...
// *************************************************************************
// Public Variables
uint_8_t SPI_UI_Status_Flag_Byte      = (uint_8_t) (0U);

/* ************************************************************************* */
/* #Defines */
/* ************************************************************************* */
/* Private define ------------------------------------------------------------*/
#define SP_INVALID_ASCII_CHAR_RETURN_CODE_u8 (uint_8_t) (0xFFU)
#define SP_CONVERSION_SUCCESS__RETURN_CODE_u8 (uint_8_t) (0x00U)
...
uint_16_t SPI_O_Sequence_Counter_u16 = (uint_16_t) (0U);
...
* \return uint_8_t binary representation of supplied ASCII value. 
*                   Range 0x00-0x0F or 0xFF if invalid
***********************************************************************/
uint_8_t SPI_ASCII_Char_To_Bin_u8_fn(const uint_8_t SP_ACB8_Ascii_Byte_u8)
{
    uint_8_t SPI_ACB8_RetVal_u8 = (uint_8_t)  (0U);
...
* \return uint_8_t ('0' - '9' & 'A' - 'F') 
*                   or SP_INVALID_ASCII_CHAR_RETURN_CODE_u8 (0xFF) if invalid
***********************************************************************/
uint_8_t SPI_Bin_u8_To_ASCII_Char_fn(const uint_8_t SP_Bin_u8_To_Convert)
{
	uint_8_t SP_Retval_u8 = (uint_8_t) (0U);
	
	if(9U >= SP_Bin_u8_To_Convert)
	{
		SP_Retval_u8 = SP_Bin_u8_To_Convert + (uint_8_t) ('0');
	}
	else if(15U >= SP_Bin_u8_To_Convert)
	{
		SP_Retval_u8 = SP_Bin_u8_To_Convert -10U;
		SP_Retval_u8 += (uint_8_t) ('A');
	}
	else
	{
...
* \return uint_8_t  SP_CONVERSION_SUCCESS__RETURN_CODE_u8
*                       or  SP_INVALID_ASCII_CHAR_RETURN_CODE_u8
***********************************************************************/
uint_8_t SPI_Bin_u8_To_ASCII_Pair_fn(const uint_8_t SPP_Bin_u8_To_Convert, uint_8_t* const SPP_Result_u8_ptr)
{
	uint_8_t SPP_x_u8              = ((uint_8_t) (0U));
	uint_8_t SPP_r_u8              = ((uint_8_t) (0U));
	uint_8_t SPP_loop_u8           = ((uint_8_t) (0U));
	uint_8_t SPP_Result_Success_u8 = SP_CONVERSION_SUCCESS__RETURN_CODE_u8; // Until proven otherwise
	const uint_8_t SPP_Shift_Table[2] = { 4U, 0U };               
	
	while( ((SPP_loop_u8 < ((uint_8_t)(2U))) && (SP_INVALID_ASCII_CHAR_RETURN_CODE_u8 != SPP_Result_Success_u8)) )
	{
		SPP_x_u8 =   SPP_Bin_u8_To_Convert;
		SPP_x_u8 >>= SPP_Shift_Table[SPP_loop_u8];
		SPP_x_u8 &=  ((uint_8_t) (0x0FU));
...
** Returned value:	uint_8_t  SP_CONVERSION_SUCCESS__RETURN_CODE_u8
**                       or  SP_INVALID_ASCII_CHAR_RETURN_CODE_u8
**                   
** 
*****************************************************************************/
...
*                       or  SP_INVALID_ASCII_CHAR_RETURN_CODE_u8
***********************************************************************/
uint_8_t SPI_Bin_u16_To_ASCII_Quad_fn(const uint_16_t SPQ_Bin_u16_To_Convert, uint_8_t* const SPQ_Result_u8_ptr)
{
	uint_16_t SPQ_x_u16              = ((uint_16_t) (0U));
	uint_8_t  SPQ_x_u8 				= ((uint_8_t)  (0U));
	uint_8_t  SPQ_r_u8               = ((uint_8_t)  (0U));
	uint_8_t  SPQ_loop_u8            = ((uint_8_t)  (0U));
	uint_8_t  SPQ_Result_Success_u8  = SP_CONVERSION_SUCCESS__RETURN_CODE_u8; // Until proven otherwise
	const uint_8_t SPQ_Shift_Table[4U] = { 12U, 8U, 4U, 0U };               
	
	
	
	while(((SPQ_loop_u8 < ((uint_8_t) (4U))) && (SP_INVALID_ASCII_CHAR_RETURN_CODE_u8 != SPQ_Result_Success_u8)))
	{
		SPQ_x_u16 =   SPQ_Bin_u16_To_Convert;
		SPQ_x_u16 >>= SPQ_Shift_Table[SPQ_loop_u8];
		SPQ_x_u16 &=  ((uint_16_t) (0x0FU));
		
		SPQ_x_u8  = (uint_8_t) (SPQ_x_u16);
...
***********************************************************************/
BOOL SPI_Construct_UI_To_MMS_Packet(const Raw_UI_To_MMS_Data_struct_type* const Raw_UI_To_MMS_Data_struct_ptr, const uint_8_t Num_Valid_Data_Items_u8, SPI_A_Outer_struct_Ascii_type& SPI_UI_To_MMS_Packet)
{
	BOOL     SCU_Return_Success_b;
	uint_8_t  SCU_Loop_u8        = ((uint_8_t)  (0U));
	uint_8_t  SCU_I_Pkt_Count_u8 = ((uint_8_t)  (0U));
	uint_8_t  SCU_x_u8           = ((uint_8_t)  (0U));
	uint_8_t  SCU_Conversion_Success_u8 = SP_CONVERSION_SUCCESS__RETURN_CODE_u8;
	...
	while((SC_OUTER_COMPLETE > SCU_Outer_Construction_Progress) && (SP_CONVERSION_SUCCESS__RETURN_CODE_u8 == SCU_Conversion_Success_u8))
	{
		...
		{
			case SC_PREAMBLE:
				for( SCU_Loop_u8 = (uint_8_t) (0U); SCU_Loop_u8 < SPI_A_O_PREAMBLE_SIZE; SCU_Loop_u8++)
				{
			...
			case SC_INNER_PACKETS:
			  ...
			  SCU_I_Pkt_Count_u8 = ((uint_8_t) (0U));
			...
			case SC_OUTER_PADDING:
				...
				{
					SPI_UI_To_MMS_Packet.O_PaddingBytes2[SCU_Loop_u8] = SPI_OUTER_PADDING_CHAR;
				}
...
* \return BOOL  TRUE = Success, FALSE = Failure.
***********************************************************************/
BOOL Convert_ASCII_Num_To_Bin_u32_fn(const uint_8_t *CAB_ASCII_To_Convert_u8_ptr, //
  	uint_32_t * const CAB_Result_Address_u32_ptr, const uint_8_t CAB_ASCII_Num_Str_Length_u8 )
{
	BOOL CAB_Conversion_Success_b     = TRUE;
	uint_32_t CAB_Result_u32      	        = (uint_32_t) ( 0U);
	uint_8_t  CAB_Loop_u8                  = (uint_8_t) (0U);
	uint_8_t  CAB_Sub_Bin_Value_u8         = (uint_8_t) (0U);
	
	if((uint_8_t) (8U) < CAB_ASCII_Num_Str_Length_u8)
	{
			//Required for future release.
	}		
	else
	{
		CAB_Loop_u8 = (uint_8_t) (0U);
		CAB_Sub_Bin_Value_u8 = (uint_8_t) (0U);
		
		while((CAB_Loop_u8 < CAB_ASCII_Num_Str_Length_u8) 
			&& (TRUE == CAB_Conversion_Success_b))
		{
			  CAB_Result_u32 <<= (uint_32_t) (4U);
        ...
        if(SP_INVALID_ASCII_CHAR_RETURN_CODE_u8 != CAB_Sub_Bin_Value_u8)
				{
					CAB_Result_u32 |= (uint_32_t) (CAB_Sub_Bin_Value_u8);
...
Raw_UI_To_MMS_Data_struct_type* const Decoded_UI_Message_str_Array, uint_8_t& NumOfPacketsRx) 
{
    BOOL     SDP_DecodeSuccess_b = TRUE;    // Until proven otherwise
    BOOL     SDP_Appropriate_Data_b = TRUE;    // Until proven otherwise
    uint_32_t SDP_Binary_Result_u32             = (uint_32_t)(0U);
    uint_8_t  *SDP_Field_To_Convert             = (uint_8_t * ) (0U);
   
    uint_8_t  SDP_Inner_Packet_Idx_u8           = (uint_8_t) (0U); 
    uint_8_t  SDP_Loop_u8                       = (uint_8_t) (0U); 
    uint_8_t  SDP_x_Shift_u8                    = (uint_8_t) (0U);
    uint_8_t  SDP_x_Offset_Idx_u8               = (uint_8_t) (0U);
    uint_8_t  SDP_x_u8                          = (uint_8_t) (0U);
    
    struct {
    uint_8_t S_Num_Valid_Packets_u8;
    uint_8_t S_UI_Status_Flags_u8;
    uint_8_t S_UI_MMS_Status_Ack_Flags_u8;
      ...
      && (TRUE == SDP_DecodeSuccess_b) && (TRUE == SDP_Appropriate_Data_b))
    {
            ...
            {                
                ...
                case  S_DECODE_MMS_EXTRACT_STATUS_VALID_PACKET_COUNT:  
                    ...
                    {
                        if( SPI_A_O_NUM_INNER_DATA_PACKETS  < (uint_8_t) (SDP_Binary_Result_u32))
                        {
                            SDP_Appropriate_Data_b = FALSE;
                        }
                        else
                        {
                           SDU_Decoded_Status_struct.S_Num_Valid_Packets_u8 = (uint_8_t) (SDP_Binary_Result_u32);
                ...
                case  S_DECODE_MMS_EXTRACT_STATUS_UI_FLAGS:  
					...
					if( TRUE == SDP_DecodeSuccess_b)
                    {
                         SDU_Decoded_Status_struct.S_UI_Status_Flags_u8 = (uint_8_t) (SDP_Binary_Result_u32);
                    }    
                ...
                case  S_DECODE_MMS_EXTRACT_STATUS_MMS_ACK_FLAGS: 
					...
					if( TRUE == SDP_DecodeSuccess_b)
                    {
                        SDU_Decoded_Status_struct.S_UI_MMS_Status_Ack_Flags_u8 = (uint_8_t) (SDP_Binary_Result_u32);
                    }                        
					Decode_UI_MMS_Packet_Sequence = S_DECODE_MMS_EXTRACT_INNER_DATA_PACKETS;
                break; //   
                
                case  S_DECODE_MMS_EXTRACT_INNER_DATA_PACKETS:   
					SDP_Inner_Packet_Idx_u8 = (uint_8_t) (0U);
                             ...
                             switch(Decode_UI_MMS_Data_Packet_Sequence) 
                             {
                                 ...
                                 break;
                                  ...
                                  case  S_MMS_DATA_DEC_DEST_ID:
						                SDP_x_u8 = (uint_8_t) ( SPI_MMS_To_UI_Packet.O_Data_Packet[SDP_Inner_Packet_Idx_u8].D_Dest_ID[0U]  );
                                 ...
                                 case  S_MMS_DATA_DEC_SOURCE_ID:
								       SDP_x_u8 = (uint_8_t) ( SPI_MMS_To_UI_Packet.O_Data_Packet[SDP_Inner_Packet_Idx_u8].D_Source_ID[0U]  );
                                 ...
                                 case  S_MMS_DATA_DEC_CAN_ID:
                                       ...
                                       if( TRUE == SDP_DecodeSuccess_b)
                                       {
                                            Decoded_UI_Message_str_Array[SDP_Inner_Packet_Idx_u8].CAN_ID_u8 =  (uint_8_t) (SDP_Binary_Result_u32);
                                       }
                                 ...
                                 case  S_MMS_DATA_DEC_CAN_DLC:
                                       ...
                                       if( TRUE == SDP_DecodeSuccess_b)
                                       {
                                            Decoded_UI_Message_str_Array[SDP_Inner_Packet_Idx_u8].CAN_DLC_u8 = (uint_8_t) (SDP_Binary_Result_u32);
                                       }
                                 ...
                                 case  S_MMS_DATA_DEC_CAN_PAYLOAD:   // Natska 
                                       ...
                                       { 
                                           ...
                                           {
                                                Decoded_UI_Message_str_Array[SDP_Inner_Packet_Idx_u8].Payload_u8[SDP_Loop_u8] = (uint_8_t) ((SDP_Binary_Result_u32) >> SDP_x_Shift_u8);
                                                SDP_x_Shift_u8 += (uint_8_t) (8U);
                                           }
                                       }
                                       ...
                                       { 
                                            ...
                                            for(SDP_Loop_u8 = 0U; SDP_Loop_u8 < 4U; SDP_Loop_u8++ )
                                            {
                                                ...
                                                Decoded_UI_Message_str_Array[SDP_Inner_Packet_Idx_u8].Payload_u8[SDP_x_Offset_Idx_u8] = (uint_8_t) ((SDP_Binary_Result_u32) >> SDP_x_Shift_u8);
                                                SDP_x_Shift_u8 += (uint_8_t) (8U);
                                            }
                                       }
